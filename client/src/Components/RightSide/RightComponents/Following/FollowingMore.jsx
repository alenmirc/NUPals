...
function FollowingMore ({showMore,setShowMore}){
  ...
  return (
    ...
    >
        {FollowingRemainingData.map((val)=>(
                  ...
                  <button className='Rbtn' style={{background:"linear-gradient(107deg, rgb(250,211,32) 11.1%, rgb(187, 158, 13) 95.3%)"}}>Follow</button>
            </div>
