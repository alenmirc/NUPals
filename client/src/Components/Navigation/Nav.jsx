  ...
  return (
    <nav>
        <div className="n-logo">
            <Link to="/home" className='logo' style={{color:"#fad320",textDecoration:"none"}}>
              <h1>NU<span>PALS</span></h1>
            </Link>
        </div>
      ...
      <Link to="/home" style={{textDecoration:"none",display:"flex",alignItems:"center",color:"yellow"}}>
